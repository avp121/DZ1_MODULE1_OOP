...
/* const char ArrOfSurnames[10][256] = {"Komarov\0", "Volkov\0", "Sinicin\0", "Galitskiy\0", "Petrosyan\0", "Vinnik\0", "Pavlov\0", "Soloviev\0", "Sidorov\0", "Polevoy\0"};
 const char ArrOfNames[10][256] = {"Dmitriy\0", "Vladimir\0", "Simeon\0", "Petr\0", "Anton\0", "Sergey\0", "Victor\0", "Svyatoslav\0", "Oleg\0", "Emelyan\0"};
 const char ArrOfSecNames[10][256] = {"Lvovich\0", "Alexandrovich\0", "Nikolayevich\0", "Vardanovich\0", "Danilovich\0", "Kirillovich\0", "Petrovich\0", "Afanasyevich\0", "Timurovich\0", "Olegovich\0"};
 const char ArrOfStreets[10][256] = {"Zelenaya\0", "Solnechnaya\0", "Revolucionerov\0", "Prikanalnaya\0", "Kosmonavtov\0", "Ingenernaya\0", "Bolotistaya\0", "Tixaya\0", "Oblachnaya\0", "Rechnaya\0"};
 const char ArrOfStreetTypes[6][256] = {"Avenue\0", "Boulevard\0", "Highway\0", "Prospect\0", "Square\0", "Street\0"};
 //char StreetTypes[6][256] = ("Avenue\0", "Boulevard\0", "Highway\0", "Prospect\0", "Square\0", "Street\0");
 const char ArrOfStructures[10][256] = {'a', 'b', 'c', 'd', 'e', '1', '2', '3', '4', '5'};
